...
{
	make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE}  O=${pwd_path}/output V=${verbose} ${uboot_config}
	make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE}  O=${pwd_path}/output V=${verbose} ${multi_thread}$1
}
